        ...
        <div className="fixed top-0 left-0 w-full h-full bg-[#000000] bg-opacity-50 flex justify-center items-center z-10">
            <div className="border border-[#C19A6B] bg-black/40 p-6 w-[400px]">
                ...
                <ul className="flex flex-col gap-3 mt-6">
                    <li className="flex justify-between items-center">EXP: <span className="flex gap-3 items-center">20<Icon icon="mdi:star-four-points-box-outline" width="24" height="24"  style={{color: '#fff'}} /></span></li>
                    <li className="flex justify-between items-center">GOLD: <span className="flex gap-3 items-center">5<Icon icon="material-symbols-light:money-bag" width="24" height="24"  style={{color: '#C19A6B'}} /></span></li>
                </ul>
